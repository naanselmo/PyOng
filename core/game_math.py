...
class Vector2(object):
    ...
    def interpolate_to(self, other, range_length):
        return Vector2(self.x + (other[0] - self.x) * range_length, self.y + (other[1] - self.y) * range_length)
